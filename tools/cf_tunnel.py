...
def cmd_setup():
    ...
    print("  cloudflared tunnel create autodl-redlens")
    ...
    print("  cloudflared tunnel route dns autodl-redlens llm.yourdomain.com")
    print("  cloudflared tunnel route dns autodl-redlens dino.yourdomain.com")
    print("  cloudflared tunnel route dns autodl-redlens depth.yourdomain.com")
    print("  cloudflared tunnel route dns autodl-redlens som.yourdomain.com")
    print()
    print("  # 创建 /root/.cloudflared/config.yml:")
    print("  tunnel: autodl-redlens")
    ...
    print('  {')
    print('    "tunnel_name": "autodl-redlens",')
